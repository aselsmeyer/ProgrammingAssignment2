## The below two functions create a special matrix that cache's its inverse.
...
## computation.  Otherwise, it calculates the inverse of the data and sets the value of the
